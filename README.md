...
| 30  | [MVC фреймворки и библиотеки?](#30)                              |

<!-- ## <a id="30"></a>
[`↑ scroll up`](#top) -->

## <a id="30"></a> MVC фреймворки и библиотеки? Зачем они нужны и кто их пишет?
...
Node.js — это среда выполнения для JS. По сути это движок V8 и ряд механизмов, позволяющих выполнять js-код вне браузера.
