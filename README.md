...
REST API — API, построенные по принципам REST (или RESTful API). Другими словами это архитектурный стиль для операций по работе с сервером, используемый для разработки API, работающих на основе протокола HTTP.
