# Вопросы с техсобесов

Репозиторий содержит популярные вопросы и ответы для подготовки к собесам на позицию веб-разработчик.

Каждый неравнодушный может внести свой вклад для пользы сообщества, участвуя в формировании и актуализации данного репозитория. Буду признателен за выявление ошибок, опечаток и неточностей в трактовании.
