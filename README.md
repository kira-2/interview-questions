...
Парадигма программирования, где основными концепциями являются понятия объектов и классов, которые образуют иерархию наследования.
...
- Полиморфизм — реализуется в JS с помощью прототипов или классов. Идея заключается в способности вызвать унаследованную функцию в собственном контексте и получить корректный результат. То есть вызывать ОДИН и тот же код для ВСЕХ допустимых типов (полиморфных) аргументов.
